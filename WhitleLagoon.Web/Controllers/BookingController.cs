...
namespace WhitleLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult BookingDetails(int bookingId)
        {
            ...
            if (bookingFromDb.VillaNumber==0 && bookingFromDb.Status == SD.StatusApproved)
            {
                ...
                bookingFromDb.VillaNumbers = _villaNumberService.GetAllVillaNumbers().Where
                    (u => u.VillaId == bookingFromDb.VillaId
        ...
        public IActionResult GenerateInvoice(int id,string downloadType)
        {
            ...
            WTableStyle tabStyle = document.AddTableStyle("CustomStyle");
            tabStyle.TableProperties.RowStripe = 1;
            tabStyle.TableProperties.ColumnStripe = 2;
            tabStyle.TableProperties.Paddings.Top = 2;
            tabStyle.TableProperties.Paddings.Bottom = 1;
            tabStyle.TableProperties.Paddings.Left = 5.4f;
            tabStyle.TableProperties.Paddings.Right = 5.4f;

            ConditionalFormattingStyle firstRowStyle = tabStyle.ConditionalFormattingStyles.Add(ConditionalFormattingType.FirstRow);
        ...
        {
            _bookingService.UpdateStatus(booking.Id, SD.StatusCanceled, 0);
        ...
        public IActionResult GetAll(string status)
        {
            ...
            bookings = _bookingService.GetAllBooking(userId,status);
