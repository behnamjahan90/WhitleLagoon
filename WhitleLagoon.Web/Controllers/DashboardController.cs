...
namespace WhitleLagoon.Web.Controllers
{
    public class DashboardController : Controller
    {
        ...
        public async Task<IActionResult> GetTotalBookingRadialChartData()
        {
            ...
            return Json(GetRadialChartDataModel(totalBookings.Count(), countByCurrentMonth, countByPrevioustMonth));
        }
        ...
        public async Task<IActionResult> GetRevenueChartData()
        {
            ...
            return Json(GetRadialChartDataModel(totalRevenue, countByCurrentMonth, countByPrevioustMonth));
        }
