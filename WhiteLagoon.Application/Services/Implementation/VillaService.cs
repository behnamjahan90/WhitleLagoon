...
namespace WhiteLagoon.Application.Services.Implementation
{
    public class VillaService : IVillaService
    {
        ...
        public IEnumerable<Villa> GetAvailabilityByDate(int nights, DateOnly checkInDate)
        {
        ...
        {
            if (!string.IsNullOrEmpty(includeProperties))
                return _unitOfWork.Villa.Get(u => u.Id == id, includeProperties: includeProperties);
            else
